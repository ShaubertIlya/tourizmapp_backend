...
export class DiscountSliderComponent implements OnInit {
  ...
  constructor(private uploadService: DiscountSliderService, private sightService: DiscountService, private router: Router, private route: ActivatedRoute) { }
  ngOnInit(): void {
    this.editId = null;
    this.editMode = false;
...
err => {	
  ...
  saveAr(): void {
    ...
    console.log(this.listImg.toString());
      ...
      discount_id: this.model.discount_id,
          ...
          const content = {	
            ...
            this.uploadService.createContent(content).subscribe(	
              response => {	
                ...
                this.router.navigate(['/discountSlider_list']);	
              },	
              error => {	
                console.log(error);	
              });
