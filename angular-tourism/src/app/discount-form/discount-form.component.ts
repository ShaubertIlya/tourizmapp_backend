...
export class DiscountFormComponent implements OnInit {
	...
	constructor(private discountService: DiscountService,
		private formBuilder: FormBuilder,private slider:DiscountSliderService,private sightService: SightService, private companyService: CompanyService, private tagService: TagService, private countryService: CountryService, private cityService: CityService, private router: Router, private route: ActivatedRoute) {
	...
	onFormSubmit() {
		...
		this.discountService.UploadImage(formData).subscribe(response => {
